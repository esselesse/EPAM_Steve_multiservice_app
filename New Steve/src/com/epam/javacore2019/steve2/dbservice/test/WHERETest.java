...
public class WHERETest {
    ...
    @Test
    public static void testOperators() {//тестирование операторов
        ...
        assert and.operate(true, true, true);//ассерт должно вернутся ТРУ (потому что нет ! ) при входных данных трутрутру
